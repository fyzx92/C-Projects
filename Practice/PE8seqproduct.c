...
*Find the set of thirteen adjacent numbers that make the largest product
*
*/
...
int main() {
	...
	int series[] = {7,3,1,6,7,1,7,6,5,3,1,3,3,0,6,2,4,9,1,9,2,2,5,1,1,
	...
	int i = 0;
	for (i = 0; i < NELEMS(series)-13; i++) {
		int product = 1;
		for (j=0; j<13; j++) product *= series(i+j)

		if (product > greatestProduct) {
			greatestProduct = product;
			printf("greatestProduct is currently %d \n", greatestProduct);
		
		}
	}

	printf("the greatest product of 13 numbers in the series is %d \n", greatestProduct);
}
